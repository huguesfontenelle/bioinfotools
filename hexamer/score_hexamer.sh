...
do
	filename=$(basename "$f")
	python /Users/huguesfo/Devel/genevar/genap/annotation/splice/score_hexamer.py -i $f -o ${filename%%.*}_hexa.json --refseq $REFSEQ --hexa $HEXAMER --refseqgene $REFSEQGENE
done
